      ...
      return (
        <div>
          ...
          </FormItem>
          {
            ...
            <FormItem
              {...formItemLayout}
              label={`${this.props.intl.formatMessage(message.activityId_last)} #${index + 1}`}
              key={index + 3}
              >
    ...
    return (
      <Form onSubmit={this.handleSubmit}>
        ...
        >
          ...
          <FormItem
            {...formItem2Layout}
            label={this.props.intl.formatMessage(message.activityId_last)}
          >
            {getFieldDecorator('visibleCondition.params.preActivityTemplateId', {
              ...
              rules: [{ required: true, message: '可见条件 前一个活动 ID!' }]
            })(
        ...
        </FormItem>
        {
          ...
          <FormItem {...tailFormItemLayout}>
            <Button type='primary' htmlType='submit' size='large'>{this.props.intl.formatMessage(message.submit)}</Button>
          </FormItem>
        }
      </Form>
    )
