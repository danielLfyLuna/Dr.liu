...
import { Form, Input, Cascader, Button, DatePicker, InputNumber, TreeSelect, Icon, Switch, Col } from 'antd'
        ...
        <div key={`activityItems-${key}`}>
          ...
          >
            {getFieldDecorator(`activityItems[${key}].activityItemId`, {
              ...
              rules: [{ required: true, message: intl.formatMessage(message.activityId) }]
            })(
              <Input disabled placeholder={intl.formatMessage(message.activityId)} style={{ width: '100%' }} />
            )}
          </FormItem>
          <FormItem
            {...formItemLayout}
          ...
          >
            {getFieldDecorator(`activityItems[${key}].description`, {
              ...
              rules: [{ required: true, message: intl.formatMessage(message.description) }]
            })(
              <Input disabled={check} placeholder={intl.formatMessage(message.description)} style={{ width: '100%' }} />
            )}
          </FormItem>
          <FormItem
            {...formItemLayout}
          ...
          >
            {getFieldDecorator(`activityItems[${key}].clientValue`, {
              ...
              rules: [{ required: true, message: intl.formatMessage(message.clientValue) }]
            })(
              <InputNumber
                min={0}
                ...
                disabled={check}
                placeholder={intl.formatMessage(message.clientValue)}
                style={{ width: '100%' }}
              />
            )}
          </FormItem>
          ...
          >
            {getFieldDecorator(`activityItems[${key}].coin`, {
              ...
              rules: [{ required: true, message: `${intl.formatMessage(message.price)}(${intl.formatMessage(message.diamond)})` }]
            })(
              <InputNumber
                min={0}
                formatter={this._numFormat}
                parser={this._numParse}
                disabled={check}
                placeholder={`${intl.formatMessage(message.price)}(${intl.formatMessage(message.diamond)})`}
                style={{ width: '100%' }}
              />
            )}
          </FormItem>
          ...
          >
            {getFieldDecorator(`activityItems[${key}].coinToken`, {
              ...
              rules: [{ required: true, message: intl.formatMessage(message.diamond_system) }]
            })(
              <InputNumber min={0} disabled placeholder={intl.formatMessage(message.diamond_system)} style={{ width: '100%' }} />
            )}
          </FormItem>
          <FormItem
            {...formItemLayout}
          ...
          >
            {getFieldDecorator(`activityItems[${key}].rmb`, {
              ...
              rules: [{ required: true, message: intl.formatMessage(message.rmb) }]
            })(
              <InputNumber min={0} disabled placeholder={intl.formatMessage(message.rmb)} style={{ width: '100%' }} />
            )}
          </FormItem>
          <FormItem
            {...formItemLayout}
          ...
          >
            {getFieldDecorator(`activityItems[${key}].vipValue`, {
              ...
              rules: [{ required: true, message: intl.formatMessage(message.vip) }]
            })(
              <InputNumber min={0} disabled placeholder={intl.formatMessage(message.vip)} style={{ width: '100%' }} />
            )}
          </FormItem>
          <FormItem
            {...formItemLayout}
          ...
          >
            {getFieldDecorator(`activityItems[${key}].targetValue`, {
              ...
              rules: [{ required: true, message: intl.formatMessage(message.target) }]
            })(
              <InputNumber min={0} disabled placeholder={intl.formatMessage(message.target)} style={{ width: '100%' }} />
            )}
          </FormItem>
          {
                  ...
                  <Col span={12} style={{ marginRight: 8 }}>
                    ...
                    >
                      {getFieldDecorator(`activityItems[${key}].rewardList[${k}].item`, {
                        ...
                        rules: [{ type: 'array', required: true, message: intl.formatMessage(message.item) }]
                      })(
                        <Cascader
                          options={itemOPt}
                          showSearch
      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        >
          {getFieldDecorator('functionId', {
            initialValue: record.functionId || null,
            rules: [{ required: true, message: intl.formatMessage(message.activity_type) }]
          })(
            <InputNumber min={0} disabled placeholder={intl.formatMessage(message.activity_type)} style={{ width: '100%' }} />
          )}
        </FormItem>
        ...
        >
          {getFieldDecorator('templateId', {
            initialValue: record.templateId || null,
            rules: [{ required: true, message: intl.formatMessage(message.activity) }]
          })(
            <InputNumber min={0} disabled placeholder={intl.formatMessage(message.activity)} style={{ width: '100%' }} />
          )}
        </FormItem>
        ...
        >
          {getFieldDecorator('name', {
            ...
            rules: [{ required: true, message: intl.formatMessage(message.activity_name) }]
          })(
            <Input disabled={check} placeholder={intl.formatMessage(message.activity_name)} />
          )}
        </FormItem>
        <FormItem
          {...formItemLayout}
        ...
        >
          ...
          >
            {getFieldDecorator('openCondition.desc', {
              ...
              <Input disabled placeholder={intl.formatMessage(message.description)} />
            )}
          </FormItem>
          <FormItem
            {...formItem2Layout}
          ...
          >
            {getFieldDecorator('openCondition.type', {
              ...
              <Input disabled placeholder={intl.formatMessage(message.type)} />
            )}
          </FormItem>
          {
            ...
            >
              {getFieldDecorator('openCondition.params.afterDays', {
                ...
                rules: [{ required: true, message: intl.formatMessage(message.afterday) }]
              })(
                <InputNumber disabled={check} placeholder={intl.formatMessage(message.afterday)} style={{ width: '100%' }} />
              )}
            </FormItem>
          }
          {
            ...
            >
              {getFieldDecorator('openCondition.params.lastDays', {
                ...
                rules: [{ required: true, message: intl.formatMessage(message.lastday) }]
              })(
                <InputNumber disabled={check} placeholder={intl.formatMessage(message.lastday)} style={{ width: '100%' }} />
              )}
            </FormItem>
          }
          {
        ...
        >
          {getFieldDecorator('clearServiceData', {
            initialValue: record.clearServiceData || false,
            rules: [{ type: 'boolean', required: true, message: intl.formatMessage(message.clear) }]
          })(
        ...
        >
          {getFieldDecorator('products', {
            initialValue: (record.productId && [`${record.productId}`]) || [],
            rules: [{ type: 'array', required: true, message: intl.formatMessage(message.product) }],
            onChange: this.handleProductSelect
          })(
            <Cascader options={productOpt} showSearch disabled placeholder={intl.formatMessage(message.product)} />
          )}
        </FormItem>
        ...
        >
          {getFieldDecorator('serverIdList', {
            ...
            rules: [{ required: true, message: intl.formatMessage(message.server) }]
          })(
            <TreeSelect
              treeData={[{
