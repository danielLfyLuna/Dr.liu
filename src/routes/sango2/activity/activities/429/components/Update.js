  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      ...
      data.activityItems = _.reduce(values.activityItems, (result, option, index) => {
        ...
        obj.completeConditionIds = [option.completeConditionIds]
                ...
                <div>
                  ...
                  >
                    ...
                    {getFieldDecorator(`activityItems[${index}].rewardList[${idx}].num`, {
                      ...
                      <InputNumber min={0} placeholder={intl.formatMessage(message.count)} disabled={check} style={{ width: '20%', marginRight: 8 }} />
                    )}
                  </FormItem>
                </div>
              )
      ...
      <Form onSubmit={this.handleSubmit}>
        ...
        >
          {getFieldDecorator('clearServiceData', {
            ...
            rules: [{ type: 'boolean', required: true, message: '是否清除服务数据' }]
          })(
            <Switch
              checkedChildren={'YES'}
