...
class UpdateForm extends Component {
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      ...
      data.openCondition = {
        ...
        params: {
          startTime: values.openCondition.params ? values.openCondition.params.startTime : detail.openCondition.params.startTime,
          endTime: values.openCondition.params ? values.openCondition.params.endTime : detail.openCondition.params.endTime
        }
      }
  ...
  render() {
    ...
    if (goodOpt.length) {
      ...
      itemsOpt = this._itemReduce(goodOpt, _.map(goodTypes))
    }
      ...
      return (
        <div>
          ...
          </FormItem>
          {
            ...
            <FormItem
              {...formItemLayout}
              label={`${intl.formatMessage(message.activity_last)} #${index + 1}`}
              key={index + 3}
              >
    ...
    return (
      <Form onSubmit={this.handleSubmit}>
        ...
        >
          ...
          >
            {getFieldDecorator('openCondition.params.startTime', {
              initialValue: detail.openCondition.params.startTime,
              rules: [{ required: true, message: '开启条件 开始!' }]
            })(
              <Input />
            )}
          </FormItem>
          ...
          >
            {getFieldDecorator('openCondition.params.endTime', {
              initialValue: detail.openCondition.params.endTime,
              rules: [{ required: true, message: '开启条件 结束!' }]
            })(
              <Input />
            )}
          </FormItem> */}
        ...
        <FormItem
          {...formItemLayout}
          label={intl.formatMessage(message.visibleCondition)}
        >
          <FormItem
            {...formItemLayout}
            label={intl.formatMessage(message.description)}
          ...
          <FormItem
            {...formItemLayout}
            label={intl.formatMessage(message.activity_last)}
          >
            {getFieldDecorator('visibleCondition.params.soldierId', {
              initialValue: detail.visibleCondition.params.soldierId,
          ...
          >
            {getFieldDecorator('visibleCondition.params.lastDays', {
              ...
              <InputNumber min={0} disabled={check} />
            )}
          </FormItem>
        </FormItem>
        <FormItem
