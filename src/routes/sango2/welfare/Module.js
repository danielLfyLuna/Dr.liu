...
function fetchGroups() {
  return (dispatch) => {
    ...
    let url = `${SANGO2_API_HOST}/welfares/groups`
    return axios({
      method: 'GET',
      url: url,
      headers: {
...
function createGroup(data) {
  return (dispatch) => {
    ...
    let url = `${SANGO2_API_HOST}/welfares/groups/add`
    return axios({
      method: 'POST',
      url: url,
      data: data.form,
...
function updateGroup(data) {
  return (dispatch) => {
    ...
    let url = `${SANGO2_API_HOST}/welfares/groups/edit`
    axios({
      method: 'PUT',
      url: url,
      data: data.form,
...
function fetchPlayers(data) {
  return (dispatch) => {
    ...
    let url = `${SANGO2_API_HOST}/welfares/groups/${data.path.groupId}`
    axios({
      method: 'GET',
      url: url,
      headers: {
...
function importPlayers(data) {
  return (dispatch) => {
    ...
    let url = `${SANGO2_API_HOST}/welfares/${data.path.groupId}`
    return axios({
      method: 'POST',
      url: url,
      data: data.form,
...
function createPlayer(data) {
  return (dispatch) => {
    ...
    let url = `${SANGO2_API_HOST}/welfares/${data.path.groupId}/addplayer`
    return axios({
      method: 'POST',
      url: url,
      data: data.form,
...
function deletePlayer(data) {
  return (dispatch) => {
    ...
    let url = `${SANGO2_API_HOST}/welfares/${data.path.groupId}/delplayer`
    axios({
      method: 'POST',
      url: url,
      data: data.form,
...
function batchPlayers(data) {
  return (dispatch) => {
    ...
    let url = `${SANGO2_API_HOST}/welfares/${data.path.groupId}/benefitopen`
    axios({
      method: 'PUT',
      url: url,
      data: data.form,
...
function fetchBatchPlayers(data) {
  return (dispatch) => {
    ...
    let url = `${SANGO2_API_HOST}/welfares/products/${data.path.productId}/servers/${data.path.serverId}/benefitopen`
    axios({
      method: 'GET',
      url: url,
      params: data.params,
