...
class PlayerFilter extends Component {
  ...
  handleReback = () => {
    this.context.router.push('/sango2/welfare/groups')
  }
      ...
      <div>
        <Form layout='inline' onSubmit={this.handleSearch}>
          <Row gutter={20} style={{ marginBottom: 8 }}>
            {
              options.authorize.includes(200103) &&
