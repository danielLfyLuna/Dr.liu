...
function getItemDetail(data) {
  return (dispatch, getState) => {
    ...
    let url = `${SANGO2_API_HOST}/products/${data.productId}/servers/${data.serverId}/trade/itemDetail`
    return axios({
      method: 'GET',
      url: url,
      params: data.time,
...
function getItemAmount(data) {
  return (dispatch, getState) => {
    ...
    let url = `${SANGO2_API_HOST}/products/${data.productId}/servers/${data.serverId}/trade/amount`
    return axios({
      method: 'GET',
      url: url,
      params: data.time,
