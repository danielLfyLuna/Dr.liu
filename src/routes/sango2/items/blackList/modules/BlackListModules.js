...
function fetchAdd(value) {
  return (dispatch, getState) => {
    ...
    dispatch(requestAdd())
    let url = `${SANGO2_API_HOST}/products/_/items/blacklist/${value.type}/templates/${value.itemList[0]}`
    axios({
      method: 'post',
      url: url,
      headers: {
...
function fetchGet(type) {
  return (dispatch, getState) => {
    ...
    dispatch(requestGet())
    let url = `${SANGO2_API_HOST}/products/_/items/blacklist/${type}`
    axios({
      method: 'get',
      url: url,
      headers: {
...
function fetchDelete(value, list) {
  return (dispatch, getState) => {
    ...
    let url = `${SANGO2_API_HOST}/products/_/items/blacklist/${value.requestType}/templates/${value.itemId}`
    axios({
      method: 'delete',
      url: url,
      headers: {
