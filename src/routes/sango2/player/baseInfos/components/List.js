...
export default class List extends Component {
  ...
  handleMenuClick = (record, e) => {
    if (e.key === '1') {
      this.props.hanleInfo(this.props.products.value, record.playerId, this.list, true)
    }

    if (e.key === '2') {
      this.props.hanleInfo(this.props.products.value, record.playerId, record, false)
    }
