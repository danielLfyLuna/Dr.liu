...
function fetchLogsConfig(value = {}) {
  return (dispatch, getState) => {
    ...
    let url = `${SANGO2_API_HOST}/products/${value.products[0]}/servers/${value.products[1]}/players/logconfig?nickname=${value.nickname}`
    axios({
      method: 'GET',
      url: url,
      headers: {
...
function updateLogsModule(value) {
  return (dispatch, getState) => {
    ...
    let url = `${SANGO2_API_HOST}/products/${value.products[0]}/servers/${value.products[1]}/players/modulelevel`
    axios({
      method: 'PUT',
      url: url,
      data: value.list,
...
function fetchDumpLogs(value = {}) {
  return (dispatch, getState) => {
    ...
    let url = `${SANGO2_API_HOST}/products/${value.products[0]}/servers/${value.products[1]}/players/dumpview?nickname=${value.nickname}`
    axios({
      method: 'GET',
      url: url,
      headers: {
...
function fetchPullLogs(value = {}) {
  return (dispatch, getState) => {
    ...
    openNotificationWithIcon('info', '请稍后')
    let url = `${SANGO2_API_HOST}/products/${value.products[0]}/servers/${value.products[1]}/players/pulllogs?nickname=${value.nickname}`
    axios({
      method: 'GET',
      url: url,
      headers: {
...
function fetchLogs(value = {}) {
  return (dispatch, getState) => {
    ...
    openNotificationWithIcon('info', '请稍后')
    let url = `${SANGO2_API_HOST}/products/${value.products[0]}/servers/${value.products[1]}/players/getlogs?nickname=${value.nickname}`
    axios({
      method: 'GET',
      url: url,
      headers: {
