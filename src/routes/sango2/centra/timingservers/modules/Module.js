...
function fetchServers(data) {
  return (dispatch, getState) => {
    ...
    let url = `${SANGO2_API_HOST}/products/1/servers/timinglist`
    return axios({
      method: 'GET',
      url: url,
      headers: {
      ...
      console.log('fetchservers response')
      console.log(response)
      console.log(response.data.domainObject)
...
function createServers(data) {
  return (dispatch, getState) => {
    ...
    let url = `${SANGO2_API_HOST}/products/${data.product}/servers/timinglist/add`
    return axios({
      method: 'POST',
      data: {
      ...
      console.log('createServers response')
      console.log(response)
...
function deleteServers(data) {
  return (dispatch, getState) => {
    ...
    console.log('deleteServers.data')
    console.log(data)
    let url = `${SANGO2_API_HOST}/products/${data.productId}/servers/timinglist/del`
    return axios({
      method: 'DELETE',
      data: {
      ...
      console.log('deleteServers response')
      console.log(response)
