...
function fetchPurchases() {
  return (dispatch, getState) => {
    ...
    const url = `${SANGO2_API_HOST}/products/payconfig/orders`
    axios({
      method: 'GET',
      url: url,
      headers: {
...
function fetchPurchaseSync(data) {
  return (dispatch, getState) => {
    ...
    const url = `${SANGO2_API_HOST}/products/payconfig/sync/products/${data.path.productId}/servers/${data.path.serverId}`
    axios({
      method: 'GET',
      url: url,
      headers: {
...
function fetchProducts() {
  return (dispatch, getState) => {
    ...
    const url = `${SANGO2_API_HOST}/products/server/options`
    return axios({
      method: 'GET',
      url: url,
      headers: {
